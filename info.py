...
BOT_TOKEN = environ.get('BOT_TOKEN', '6383215969:AAEVxNJ5QDBQ0ZwiwqEO0s6fZPMzIEs2Tvg')
...
# Bot Admins
ADMINS = [int(admins) if id_pattern.search(admins) else admins for admins in environ.get('ADMINS', '1946827941').split()]
...
# Channels
INDEX_CHANNELS = [int(index_channels) if id_pattern.search(index_channels) else index_channels for index_channels in environ.get('INDEX_CHANNELS', '-1001942386281').split()]
auth_channel = environ.get('AUTH_CHANNEL', '')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001942386281'))

# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://jagadeesh:jagadeesh@jagadeesh.e1djkgq.mongodb.net/?retryWrites=true&w=majority")
